...
std::vector<Python3Parser::Add_subContext *> Python3Parser::Arith_exprContext::add_sub() {
  return getRuleContexts<Python3Parser::Add_subContext>();
}

Python3Parser::Add_subContext* Python3Parser::Arith_exprContext::add_sub(size_t i) {
  return getRuleContext<Python3Parser::Add_subContext>(i);
}
...
Python3Parser::Add_subContext::Add_subContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* Python3Parser::Add_subContext::ADD() {
  return getToken(Python3Parser::ADD, 0);
}

tree::TerminalNode* Python3Parser::Add_subContext::MINUS() {
  return getToken(Python3Parser::MINUS, 0);
}


size_t Python3Parser::Add_subContext::getRuleIndex() const {
  return Python3Parser::RuleAdd_sub;
}

void Python3Parser::Add_subContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<Python3Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterAdd_sub(this);
}

void Python3Parser::Add_subContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<Python3Listener *>(listener);
  if (parserListener != nullptr)
...
antlrcpp::Any Python3Parser::Add_subContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<Python3Visitor*>(visitor))
...
Python3Parser::Add_subContext* Python3Parser::add_sub() {
  Add_subContext *_localctx = _tracker.createInstance<Add_subContext>(_ctx, getState());
  enterRule(_localctx, 50, Python3Parser::RuleAdd_sub);
  size_t _la = 0;
...
std::vector<Python3Parser::Mtp_divContext *> Python3Parser::TermContext::mtp_div() {
  return getRuleContexts<Python3Parser::Mtp_divContext>();
}

Python3Parser::Mtp_divContext* Python3Parser::TermContext::mtp_div(size_t i) {
  return getRuleContext<Python3Parser::Mtp_divContext>(i);
}
...
Python3Parser::Mtp_divContext::Mtp_divContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}

tree::TerminalNode* Python3Parser::Mtp_divContext::STAR() {
  return getToken(Python3Parser::STAR, 0);
}

tree::TerminalNode* Python3Parser::Mtp_divContext::DIV() {
  return getToken(Python3Parser::DIV, 0);
}

tree::TerminalNode* Python3Parser::Mtp_divContext::IDIV() {
  return getToken(Python3Parser::IDIV, 0);
}

tree::TerminalNode* Python3Parser::Mtp_divContext::MOD() {
  return getToken(Python3Parser::MOD, 0);
}


size_t Python3Parser::Mtp_divContext::getRuleIndex() const {
  return Python3Parser::RuleMtp_div;
}

void Python3Parser::Mtp_divContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<Python3Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterMtp_div(this);
}

void Python3Parser::Mtp_divContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<Python3Listener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitMtp_div(this);
}


antlrcpp::Any Python3Parser::Mtp_divContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<Python3Visitor*>(visitor))
    return parserVisitor->visitMtp_div(this);
  else
    return visitor->visitChildren(this);
}

Python3Parser::Mtp_divContext* Python3Parser::mtp_div() {
  Mtp_divContext *_localctx = _tracker.createInstance<Mtp_divContext>(_ctx, getState());
  enterRule(_localctx, 54, Python3Parser::RuleMtp_div);
  size_t _la = 0;
...
std::vector<std::string> Python3Parser::_ruleNames = {
  ...
  "arith_expr", "add_sub", "term", "mtp_div", "factor", "atom_expr", "trailer", 
