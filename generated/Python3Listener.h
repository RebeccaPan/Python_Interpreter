...
public:
  ...
  virtual void enterAdd_sub(Python3Parser::Add_subContext *ctx) = 0;
  virtual void exitAdd_sub(Python3Parser::Add_subContext *ctx) = 0;

  virtual void enterTerm(Python3Parser::TermContext *ctx) = 0;
  virtual void exitTerm(Python3Parser::TermContext *ctx) = 0;

  virtual void enterMtp_div(Python3Parser::Mtp_divContext *ctx) = 0;
  virtual void exitMtp_div(Python3Parser::Mtp_divContext *ctx) = 0;
