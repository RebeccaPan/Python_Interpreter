...
public:
  ...
  virtual antlrcpp::Any visitAdd_sub(Python3Parser::Add_subContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitMtp_div(Python3Parser::Mtp_divContext *ctx) override {
    return visitChildren(ctx);
  }
