...
public:
  ...
  enum {
    ...
    RuleComp_op = 23, RuleArith_expr = 24, RuleAdd_sub = 25, RuleTerm = 26, 
    RuleMtp_div = 27, RuleFactor = 28, RuleAtom_expr = 29, RuleTrailer = 30, 
...
//currentWorkPlace
  ...
  public:
    ...
    std::vector<Add_subContext *> add_sub();
    Add_subContext* add_sub(size_t i);
  ...
  public:
    ...
    std::vector<Mtp_divContext *> mtp_div();
    Mtp_divContext* mtp_div(size_t i);
  ...
  class  Mtp_divContext : public antlr4::ParserRuleContext {
  public:
    Mtp_divContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
