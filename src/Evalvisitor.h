...
class EvalVisitor: public Python3BaseVisitor {
  ...
  virtual antlrcpp::Any visitAdd_sub(Python3Parser::Add_subContext *ctx) override;//not default

  virtual antlrcpp::Any visitTerm(Python3Parser::TermContext *ctx) override;

  virtual antlrcpp::Any visitMtp_div(Python3Parser::Mtp_divContext *ctx) override;//not default
